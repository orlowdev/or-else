...
test('left.getOrElse returns the result of the provided function', (t) => {
	t.is(
		Either.left(1).getOrElse((x) => x + 1),
		2,
	)
})

test('right.getOrElse returns the context', (t) => {
	t.true(Either.right(true).getOrElse(() => false))
})
